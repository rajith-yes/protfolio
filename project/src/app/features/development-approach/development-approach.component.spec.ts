...
describe('DevelopmentApproachComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DevelopmentApproachComponent]
    }).compileComponents();
  ...
  it('should create development approach component', () => {
    expect(component).toBeTruthy();
  });

  it('should render 4 practice cards', () => {
    expect(component.practices.length).toBe(4);
  });
});
